...
The project demonstrates a **production-ready ML pipeline**, covering preprocessing, model training, deployment, and real-time inference.
...
- Uses saved **OneHotEncoder, LabelEncoder, and StandardScaler**
